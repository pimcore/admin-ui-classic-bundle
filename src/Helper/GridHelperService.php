                ...
                if (isset($filter['value'])) {
                    ...
                    if ($field instanceof ClassDefinition\Data\Objectbricks || $brickDescriptor) {
                        ...
                        if (is_array($filter['value'] ?? false)) {
                            ...
                            $conditionPartsFilters[] = $field->getFilterCondition($filter['value'] ?? null, $operator, ['brickPrefix' => ($tablePrefix ? $tablePrefix . '.' : null), 'tablePrefix' => ($tablePrefix ? $tablePrefix . '.' : null)]);
                        }
